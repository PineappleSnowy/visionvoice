...
API_KEY = 'rd5C8plm9iNiKfSr4RFhps7I'
SECRET_KEY = 'HA9LmFCIpKrGh0Cy1nT9nvZpbOHRbKf5'
...
def audio_generate(TEXT, file_prefix):
    token = fetch_token()
    ...
    save_file = "error.txt" if has_error else file_prefix + '.' + FORMAT
